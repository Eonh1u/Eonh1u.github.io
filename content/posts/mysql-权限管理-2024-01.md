...
![权限层级范围示意图](/images/mysql-monthly/2024-01/privilege-scope.jpg)
...
![静态权限与控制范围](/images/mysql-monthly/2024-01/all-privileges.png)

例如 `mysql.user` 表结构如下：

![mysql.user 表结构](/images/mysql-monthly/2024-01/user-table.png)

权限变化示例：

无权限状态：

![无权限状态](/images/mysql-monthly/2024-01/no-privilege.png)

授予 global select 后：

![global select 权限](/images/mysql-monthly/2024-01/global-select-privilege.png)

授予列级 update 后：

![列级 update 权限](/images/mysql-monthly/2024-01/column-update-privilege.jpg)
